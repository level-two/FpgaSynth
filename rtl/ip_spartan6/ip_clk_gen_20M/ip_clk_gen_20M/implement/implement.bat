...
xst -ifn xst.scr
move ip_clk_gen_20M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ip_clk_gen_20M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ip_clk_gen_20M_exdes.ucf ip_clk_gen_20M_exdes

echo 'Running map'
map -timing -pr b ip_clk_gen_20M_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ip_clk_gen_20M_exdes -w routed.ncd routed.vhd
cd ..
