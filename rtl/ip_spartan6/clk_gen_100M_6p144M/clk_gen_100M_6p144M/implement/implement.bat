...
xst -ifn xst.scr
move clk_gen_100M_6p144M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_gen_100M_6p144M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_gen_100M_6p144M_exdes.ucf clk_gen_100M_6p144M_exdes

echo 'Running map'
map -timing -pr b clk_gen_100M_6p144M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_gen_100M_6p144M_exdes -w routed.ncd routed.v
cd ..
